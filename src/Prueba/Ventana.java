...
public class Ventana extends JFrame {
	...
	public void calculadora() {
		...
		panel_user.setLayout(mi_layout1);
		this.add(panel_user);
		...
		panel_user.add(field,BorderLayout.NORTH);
		
		JPanel centro = new JPanel();
		centro.setBackground(Color.red);
		centro.setLayout(new GridLayout(4,3));
		panel_user.add(centro,BorderLayout.CENTER);
		...
		panel_user.add(sidebar,BorderLayout.EAST);
